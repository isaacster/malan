...
namespace PocHomeAssignmentRestApi.Controllers
{
    ...
    public class OrderDetailGateController : ControllerBase
    {
        ...
        public OrderDetailGateController()
        {
        ...
        public async Task<ActionResult> Get()
        {
            ...
            HttpResponseMessage response = await _httpClient.GetAsync("/OrderItems");
        ...
        public async Task<string> AddOrderItems(OrderItems orderItem)
        {
            ...
            HttpResponseMessage response = await _httpClient.PostAsync("/OrderItems", SerializeOrderItem(orderItem));
        ...
        private static StringContent SerializeOrderItem(OrderItems orderItem)
        {
            // Serialize the employee object to JSON
            string employeeJson = Newtonsoft.Json.JsonConvert.SerializeObject(orderItem);
            var content = new StringContent(employeeJson, Encoding.UTF8, "application/json");
            return content;
        }
